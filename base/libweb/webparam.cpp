...
int main()
{
	webparam objCgiParam;
	map<string, string> mapParam;

	mapParam = objCgiParam.get();

	cout << "Content-Type:text/html\n\n";
	
	cout << "content:<br>" << objCgiParam.get_cont() << "<br><br>" << endl;
	cout << "cookie:<br>" << objCgiParam.get_cookie() << "<br><br>" << endl;
	
	map<string, string>::iterator pos;
	for(pos = mapParam.begin(); pos != mapParam.end(); pos++)
	{
		cout << "[" << pos->first << "]=" << "[" << pos->second << "]<br>" << endl;
	}
